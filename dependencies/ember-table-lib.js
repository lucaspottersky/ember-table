...
},{"./ember-table-templates.js":2,"../../lib/ember-addepar-mixins/resize_handler":3,"../../lib/ember-addepar-mixins/style_bindings":4,"./utils/jquery_fix":5,"./utils/lazy_container_view":6,"./utils/utils":7,"./row_selection_mixin":8,"./column":9,"./views":10,"./component":11}],3:[function(require,module,exports){
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "Ember.Table.ScrollPanel", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("\n  </div>\n</div>\n");
  return buffer;
